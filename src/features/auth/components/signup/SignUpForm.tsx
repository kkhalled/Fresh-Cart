...
export default function SignUpForm() {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      {/* ── EXACT SAME BG LAYERS AS HERO ── */}

      {/* 1. Dot grid */}

      {/* 3. Amber blob bottom-left */}
      ...
      {/* Card */}
      <div
        className="relative z-10 w-full max-w-137.5 mx-auto px-5"
        style={{
        ...
        <div className="bg-white/75 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/[0.07] border border-gray-200/60 px-6 py-6">
          ...
          <div className="flex gap-2.5 mb-4">
            {[
              ...
              <button
                key={label}
                type="button"
                className="group flex-1 flex items-center justify-center gap-1.5 py-2 bg-white/60 border border-gray-200/80 rounded-xl text-gray-700 text-[11px] font-semibold hover:bg-white hover:border-gray-300 transition-all duration-200"
              >
                <FontAwesomeIcon
                  icon={icon}
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-white/75 text-[9px] text-gray-400 font-bold uppercase tracking-[0.14em]">
